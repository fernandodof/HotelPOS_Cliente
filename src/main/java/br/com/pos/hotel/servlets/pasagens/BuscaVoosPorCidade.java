 ...
 * @author filipe
 */
@WebServlet(name = "BuscaVoosPorCidade", urlPatterns = {"/Passagens/BuscaVoosPorCidade"})
public class BuscaVoosPorCidade extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Voo voo = passagens.getVooOrigemDestino(origem, destino);
        

        List<Voo> voos = new ArrayList<>();
        voos.add(voo);
        
        request.getSession().setAttribute("voos", voos);
