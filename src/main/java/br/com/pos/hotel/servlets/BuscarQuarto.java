 ...
 * @author Fernando
 */
@WebServlet(name = "BuscarQuarto", urlPatterns = {"/BuscarQuarto"})
public class BuscarQuarto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Quarto quarto = consumidor.getQuartoById(idQuarto);
        request.getSession().setAttribute("quarto", quarto);
